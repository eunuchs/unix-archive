...
struct	inode
{
	...
	short	i_uid;		/* owner */
	ino_t	i_acl;		/* access control file (was gid) */
	off_t	i_size;		/* size of file */
	unsigned short	i_dmask;	/* permissions mask for directory */
	union {
		struct {
	...
	unsigned int	i_lastuse;	/* low-order part of last-use time */
};
...
#define		IFPIP	0010000	/* named pipe */
#define	ISUID	04000		/* set user id on execution */
#define	ISGID	02000		/* set group id on execution */
#define	INDMODE	ISGID		/* do not include default directory mode */
#define ISVTX	01000		/* save swapped text even after use */
#define	IREAD	0400		/* read, write, execute permissions */
#define	IWRITE	0200
#define	IEXEC	0100

#define	DEFMODE	0666	/* default permission mode */
