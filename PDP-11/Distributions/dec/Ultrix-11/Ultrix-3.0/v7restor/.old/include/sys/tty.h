...
struct tty
{
	...
	char	t_lno;		/* line number within page */
	char	t_pagelen;	/* page length in lines */
	union {
		struct tc;
		struct clist t_ctlq;
	} t_un;
...
#define	PAGING	DKCMD		/* page pause in progress */
#define	PAGED	DKCALL		/* paged output in effect */
