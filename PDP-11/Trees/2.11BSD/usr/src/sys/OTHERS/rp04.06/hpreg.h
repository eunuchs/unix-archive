...
/*
 * Definitions for SMD-type disk drives and drivers.  That includes DIVA's,
 * RM02/03/05, RP04/05/06, and everything using the XP driver.
 */
...
/*
 * These three drive types are dummies because the actual numbers conflict
