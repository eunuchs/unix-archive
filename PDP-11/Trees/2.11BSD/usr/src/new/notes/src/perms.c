...
#ifdef	RCSIDENT
static char rcsid[] = "$Header: /usr/local/src/usenet/notes/src/RCS/perms.c,v 1.8 88/11/10 21:49:23 paul Exp $";
#endif	RCSIDENT
 ...
 *	kernels.  2.9BSD had groups as of the Seismo/Harvard update tape SMS
 *	This could be extended to read from /etc/groups to actually give
 *	the user all groups he is permitted.
 */

#if	defined (V7) || defined (BSD41) || defined (BSD28) || defined (USG)
